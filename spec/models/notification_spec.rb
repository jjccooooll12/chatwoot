...
RSpec.describe Notification do
  ...
  context 'when push_title is called' do
    it 'returns appropriate title suited for the notification type conversation_creation' do
      ...
      expect(notification.push_message_title).to eq "A conversation (##{notification.primary_actor.ticket_number}) \
...
has been assigned to you"
    ...
    it 'returns appropriate title suited for the notification type assigned_conversation_new_message' do
      ...
      expect(notification.push_message_title).to eq "A new message is created in conversation (##{notification.primary_actor.ticket_number})"
    end
    ...
    it 'returns appropriate title suited for the notification type conversation_mention' do
      ...
      expect(notification.push_message_title).to eq "You have been mentioned in conversation (##{notification.primary_actor.ticket_number})"
    end
  end
