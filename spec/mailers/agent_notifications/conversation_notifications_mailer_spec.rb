...
RSpec.describe AgentNotifications::ConversationNotificationsMailer do
  ...
  describe 'conversation_creation' do
    ...
    it 'renders the subject' do
      expect(mail.subject).to eq("#{agent.available_name}, A new conversation [ID - #{conversation
        .ticket_number}] has been created in #{conversation.inbox&.sanitized_name}.")
    end
  ...
  describe 'conversation_assignment' do
    ...
    it 'renders the subject' do
      expect(mail.subject).to eq("#{agent.available_name}, A new conversation [ID - #{conversation.ticket_number}] has been assigned to you.")
    end
  ...
  describe 'conversation_mention' do
    ...
    it 'renders the subject' do
      expect(mail.subject).to eq("#{agent.available_name}, You have been mentioned in conversation [ID - #{conversation.ticket_number}]")
    end
  ...
  describe 'assigned_conversation_new_message' do
    ...
    it 'renders the subject' do
      expect(mail.subject).to eq("#{agent.available_name}, New message in your assigned conversation [ID - #{message.conversation.ticket_number}].")
    end
  ...
  describe 'participating_conversation_new_message' do
    ...
    it 'renders the subject' do
      expect(mail.subject).to eq("#{agent.available_name}, New message in your participating conversation [ID - #{message.conversation.ticket_number}].")
    end
