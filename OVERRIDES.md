...
| `app/javascript/dashboard/components-next/sidebar/SidebarDialer.vue` | Adds the Freshcaller-style bottom-left outbound call dialer with country/inbox selectors, number entry, recent-call registry, and existing Twilio/WhatsApp call initiation hooks. | `chatwoot/chatwoot@v4.16.1` |
